...
export default function ManageAdsPage() {
  ...
  const [deleteConfirmItem, setDeleteConfirmItem] = useState<AdItem | null>(null);
  ...
  const handleDelete = async (item: AdItem) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showToastMessage("تم حذف الإعلان بنجاح ✓");
      } else {
        showToastMessage("فشل في حذف الإعلان ✗");
      }
    } catch {
      showToastMessage("فشل في حذف الإعلان ✗");
    }
          ...
          >
            ...
            <div className="px-5 py-4 flex-1 overflow-y-auto">
              ...
              <div className="mt-4 flex justify-end gap-2">
                ...
                <button
                  onClick={() => { setDeleteConfirmItem(selectedAds); closeModal(); }}
      ...
      {deleteConfirmItem && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[70]" onClick={() => setDeleteConfirmItem(null)}>
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl animate-fade-in" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-gray-600 text-center mb-6">هل أنت متأكد من حذف هذا الإعلان؟ لا يمكن التراجع عن هذا الإجراء.</p>
